...
import { Button, Form, Grid, Header, Image, Message, Segment, con, Label, Input, Table, Rating} from 'semantic-ui-react';
import { BrowserRouter as Router, withRouter, Redirect, Switch, Route, Link, BrowserRouter } from "react-router-dom";

class AlarmHistoryListPage extends Component {
    render() {
        return (
            <Table celled padded>
                <Table.Header>
...
export default withRouter(AlarmHistoryListPage);